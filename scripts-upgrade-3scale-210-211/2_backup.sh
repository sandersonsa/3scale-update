...
# https://access.redhat.com/documentation/en-us/red_hat_3scale_api_management/2.11/html-single/migrating_3scale/index#upgrade-template
# 3scale supports upgrade paths from 2.10 to 2.11 with templates on OpenShift 3.11.

echo " ## ## Creating a backup of the 3scale project"

BACKUP_FOLDER=prod-backup-2.10-amp
