...
BACKUP_FOLDER=prod-backup-2.9-amp
...
echo " ## ## Create a back-up file with the existing DeploymentConfigs"
...
echo " ## ## Backup all existing OpenShift resources in the project"
...
echo " ## ## Create a back-up file with the additional elements"
...
echo " ## ## Backups de demais recurso"
